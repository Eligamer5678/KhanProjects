import { frameRate, color } from './khanVars.js';
...
// [new] requires transform functions
...
if(keys[32]&&crown===3){
    ...
    if(keys[32]&&supreme_mode===false&&crown===1){
        frameRate(500);
        using_ability=true;
    }else{frameRate(60); using_ability=false;if(crown===2){frameRate(framesPer);}}
    if(sppppeeed3===true){
    fill(255, 0, 0);
