...
pParticleSystem.prototype.run = function() {
  for (var i = this.pparticles.length-1; i >= 0; i--) {
...
backgroundParticleSystem.prototype.run = function() {
  for (var i = this.backgroundparticles.length-1; i >= 0; i--) {
...
for(var a = 0; a < psystems.length; a++){
...
draw = function() {
    ...
    PX = pos*100;
    background(0, 0, 0);
    for(var a = 0; a < backgroundsystems.length; a++){
...
for (var i = 0; i < drawing.length; i++) {
    stroke(drawing[i][0]);
    for (var ii = 1; ii < drawing[i].length-1; ii++) {
         ...
         fill(255, 255, 255);
           ...
           text(" Tap 1/3 line to swich pages, top/bottem of screen to swich games",85,571);
            ...
            if(page===1&& gametype===-1){
                ...
                strokeWeight(1);
                fill(255, 255, 255);
                text("Convert1000 p",15,61,69,50);
            ...
            if(page===2 &&gametype===1){
                ...
                textSize(20);
                text("     Press right/left keys to move.  The first number is your score, and the second  is your high score.  WARNING: Reloading wipes out your high score!                                                                                                  Block dodger:   You have to survive as long as you can! Collect the yellow blocks to gain score and get a one-hit immunity.                                                                                                                                                                                                                                                                                        Press left to go back to tittle screen",0,93,400,600);
            }
            ...
            keyPressed = function(){
        if(keyCode===RIGHT && keyPressed&& page !==2){
            page += 1;
        }
        if(keyCode===LEFT && keyPressed&& page !==0){
            page -= 1;
        }
        if(keyCode===32 && keyPressed && gametype===1 && titlescene === false){
            titlescene=true;
            page=1;
        }else
        if(keyCode===32 && keyPressed && gametype===2 && titlescene === false){
            titlescene=true;
            page=1;
        }else
        if(keyCode===32 && keyPressed && gametype===2 && titlescene === true){
            titlescene=false;
            page=1;
        }else
        if(keyCode===32 && keyPressed && gametype===1 && titlescene === true){
            titlescene=false;
            page=1;
        }else
        if(keyCode===32 && keyPressed && gametype===3 && titlescene === false){
            titlescene=true;
            page=1;
        }else
        if(keyCode===32 && keyPressed && gametype===3 && titlescene === true){
            titlescene=false;
            page=1;
        }
            };
...
//How the player moves
 keyReleased = function(){
    ...
    if(keyCode===DOWN&&gametype===-1&&titlescene===true){gametype=1;}else
    if(keyCode===UP&&gametype===1&&titlescene===true){gametype=-1;}
    if(u4b===true||u5b===true||u6b===true){
    if(keyCode===DOWN&&gametype===1&&titlescene===true){gametype=2;}else
    if(keyCode===DOWN&&gametype===2&&titlescene===true){gametype=3;}else
    if(keyCode===UP&&gametype===2&&titlescene===true){gametype=1;}else
    if(keyCode===UP&&gametype===3&&titlescene===true){gametype=2;}
    }else if(keyCode===UP&&gametype!==1&&gametype!==-1 || keyCode===DOWN &&gametype!==-1){
        textSize(20);
        fill(255, 0, 0);
        text("Unlock tier 2 skins first!",20,200);
    }
    if(keyCode===UP&&gametype===3&&titlescene===false){  
        if(subjects.length<=ammo){
    subjectCreate();
    playSound(getSound("retro/laser2"));
        }}
        if(keyCode===UP && titlescene===false){
            //multis=2;
        }else{
            multis=1;
        }
    ...
    if(keyCode===68&&master === 0 ){
        master=1;
    }
    if(keyCode===79&&master === 1 ){
        master=2;
    }
    if(keyCode===68&&master === 2){
        master=3;
    }
    if(keyCode===71&&master === 3 ){
        master=4;
    }
   
    if(keyCode===69&&master === 4 ){
        skillpoints+=1000;
    }
